...
public class FixDozerBeanMapperFactoryBean implements FactoryBean<Mapper>,
    InitializingBean, DisposableBean, ApplicationContextAware {

  FixDozerBeanMapper beanMapper;
   ...
   * {@code
   *   <bean class="org.dozer.spring.FixDozerBeanMapperFactoryBean">
  ...
  public final void afterPropertiesSet() throws Exception {
    this.beanMapper = new FixDozerBeanMapper();
