...
import org.simpleworkflow.service.impl.ReportServiceImpl;
...
public class ReportServiceTest {
	...
	private static List<Report> allReports = new ArrayList<Report>();
	...
	public void testFindPaginatedDirection() {
		...
		Assertions.assertThat(pageRequest.getValue().getSort().getOrderFor("id").getDirection()).isNotNull()
				.isEqualTo(Sort.Direction.ASC);
		Assertions.assertThat(pageRequest.getValue().getSort().getOrderFor("name")).isNotNull();
		Assertions.assertThat(pageRequest.getValue().getSort().getOrderFor("name").getDirection()).isNotNull()
				.isEqualTo(Sort.Direction.ASC);
