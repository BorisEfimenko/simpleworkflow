 ...
 */
public class FixDozerBeanMapper implements Mapper {

  private final Logger log = LoggerFactory.getLogger(FixDozerBeanMapper.class);
  ...
  public FixDozerBeanMapper() {
    this(Collections.<String>emptyList());
  }

  public FixDozerBeanMapper(List<String> mappingFiles) {
  ...
  void loadCustomMappings() {
    ...
    //added by redfox
    Collection<CustomConverterDescription> converterDescriptions = new ArrayList<CustomConverterDescription>();
    for (CustomConverter customConverter : customConverters) {
      if (DozerGlobalConverter.class.isAssignableFrom(customConverter.getClass())) {
        CustomConverterDescription converterDesription = new CustomConverterDescription();
        converterDesription.setType(((DozerGlobalConverter< ? , ? >) customConverter).getClass());
        converterDesription.setClassA(((DozerGlobalConverter< ? , ? >) customConverter).getPrototypeA());
        converterDesription.setClassB(((DozerGlobalConverter< ? , ? >) customConverter).getPrototypeB());
        converterDescriptions.add(converterDesription);
      }
    }    
    this.globalConfiguration.getCustomConverters().getConverters().addAll(converterDescriptions);
  }
